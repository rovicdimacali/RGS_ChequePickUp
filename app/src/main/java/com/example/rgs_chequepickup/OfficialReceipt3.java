...
public class OfficialReceipt3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_official_receipt3);

        ReceiptManagement rm = new ReceiptManagement(OfficialReceipt3.this);
        LocationManagement lm = new LocationManagement(OfficialReceipt3.this);
        scenarioManagement sm = new scenarioManagement(OfficialReceipt3.this);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(OfficialReceipt3.this, R.layout.simple_spinner_item, payeeList);
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OfficialReceipt3.this, OfficialReceipt2.class);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                submit_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    /*if (remark.equals("Multiple Accounts, Multiple Cheques") || remark.equals("One Account, Multiple Cheques")) {
                        ...
                        Intent intent = new Intent(OfficialReceipt3.this, ChequeReceived.class);
                        startActivity(intent);
                        finish();
                    }
                });
                ...
                addBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(OfficialReceipt3.this, OfficialReceipt4.class);
