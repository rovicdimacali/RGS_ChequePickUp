...
public class OfficialReceipt5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_official_receipt5);

        ReceiptManagement rm = new ReceiptManagement(OfficialReceipt5.this);
        LocationManagement lm = new LocationManagement(OfficialReceipt5.this);
        scenarioManagement sm = new scenarioManagement(OfficialReceipt5.this);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(OfficialReceipt5.this, R.layout.simple_spinner_item, payeeList);
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OfficialReceipt5.this, OfficialReceipt4.class);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                submit_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    /*if (remark.equals("Multiple Accounts, Multiple Cheques") || remark.equals("One Account, Multiple Cheques")) {
                        ...
                        Intent intent = new Intent(OfficialReceipt5.this, ChequeReceived.class);
                        startActivity(intent);
                        finish();
                    }
                });
                ...
                /*addBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        amountList = or.getStringExtra("amount") + "," + cheq_amount.getText().toString();
                        numList = or.getStringExtra("number") + "," + cheq_num.getText().toString();
                        serviceList = or.getStringExtra("payee") + "," + service;
                        bcodeList = or.getStringExtra("bcode") + "," + bcode.getText().toString();
                        ornumList = or.getStringExtra("ornum") + "," + ornum.getText().toString();
                        dateList = or.getStringExtra("date") + "," + date.getText().toString();

                        ReceiptSession rs = new ReceiptSession(String.valueOf(tin.getText()), amountList, numList, serviceList, bcodeList,
                                ornumList, dateList);
                        rm.saveReceipt(rs);

                        Intent intent = new Intent(OfficialReceipt5.this, OfficialReceipt2.class);
                        intent.putExtra("amount", amountList);
                        intent.putExtra("number", numList);
                        intent.putExtra("payee", serviceList);
                        intent.putExtra("bcode", bcodeList);
                        intent.putExtra("ornum", ornumList);
