...
public class OfficialReceipt4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_official_receipt4);

        ReceiptManagement rm = new ReceiptManagement(OfficialReceipt4.this);
        LocationManagement lm = new LocationManagement(OfficialReceipt4.this);
        scenarioManagement sm = new scenarioManagement(OfficialReceipt4.this);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(OfficialReceipt4.this, R.layout.simple_spinner_item, payeeList);
        ...
        back_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(OfficialReceipt4.this, OfficialReceipt3.class);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                submit_btn.setOnClickListener(new View.OnClickListener() {
                    ...
                    /*if (remark.equals("Multiple Accounts, Multiple Cheques") || remark.equals("One Account, Multiple Cheques")) {
                        ...
                        Intent intent = new Intent(OfficialReceipt4.this, ChequeReceived.class);
                        startActivity(intent);
                        finish();
                    }
                });
                ...
                addBtn.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent intent = new Intent(OfficialReceipt4.this, OfficialReceipt5.class);
